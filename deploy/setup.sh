...
# Do NOT edit docker-compose.yml — put overrides here instead.
WG_HOST=${WG_HOST:-}
...
if $COMPOSE_CMD -f "$REPO_DIR/docker-compose.yml" pull; then
...
# Host:   use docker-compose.yml as-is (all config comes from deploy/.env).
...
echo -e "    docker compose -f docker-compose.yml pull"
