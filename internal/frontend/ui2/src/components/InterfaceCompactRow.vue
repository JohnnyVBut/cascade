...
.actions { display: flex; align-items: center; gap: 4px; grid-row: span 2; justify-self: end; }
.actions .icon-btn { width: 30px; height: 30px; }
.divider { grid-column: 1 / -1; border-bottom: 1px solid var(--border); margin: 9px 0 0; }
</style>
