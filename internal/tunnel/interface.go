...
type TunnelInterface struct {
	...
	Protocol      string             `json:"protocol"` // "wireguard-1.0" | "amneziawg-2.0" | "amneziawg-3.0"
...
type InterfaceInput struct {
	...
	ListenPort    int
	Protocol      string // "wireguard-1.0" | "amneziawg-2.0" | "amneziawg-3.0"
	DisableRoutes bool
...
func (t *TunnelInterface) save() error {
	...
	if t.AWG2 != nil {
		...
		hpk = db.NullIfEmpty(a.HeaderProtectionKey)
		cpa = db.NullIfEmpty(a.ContentPaddingAddition)
		rat = db.NullIfEmpty(a.RekeyAfterTime)
		rt = db.NullIfEmpty(a.RekeyTimeout)
...
func (t *TunnelInterface) generateWgConfig() string {
	...
	if awgparams.IsAmneziaWG(t.Protocol) && t.AWG2 != nil {
		a := t.AWG2
...
func scanInterface(id string) (*TunnelInterface, error) {
	...
	if jc.Valid {
		t.AWG2 = &peer.AWG2Settings{
			...
			ContentPaddingAddition: cpa.String,
			RekeyAfterTime:         rat.String,
			RekeyTimeout:           rt.String,
