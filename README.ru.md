...
| Модуль | Описание |
|--------|----------|
| 🔌 **Интерфейсы** | Несколько туннельных интерфейсов WireGuard / AmneziaWG, быстрое создание, импорт `.conf` как аплинк |
| 👥 **Пиры** | Клиентские и S2S-пиры (site-to-site) с QR-кодами, статистикой трафика и ограничением скорости на каждого клиента |
